...
import { getCardDataMis2 } from "../../../camunda_redux/redux/action";
...
const MisTableIncoming = (props) => {
    const { setSelectionMode2, setHeaderText2, setLoadingBln, setLoad, loader } = props;
    ...
    useEffect(() => {
        ...
        let sauId = 0;
        props.getCardDataMis2(groupName, sauId).then((res) => {
            temp.unshift(res)
            temp[0].parentId = 0
            // temp.unshift(obj)
            setRowData(temp)
    ...
    const handleClick = (e, value, column, row) => {
        ...
        setHeaderText2({ "Data": data, "ColumnName": column.name, "Value": value, "SAU": row.sauBranch, "tabIndex": tabIndex });
        setTimeout(
...
export default connect(mapStateToProps, { setLoadData, getCardDataMis2, getMISTableList, getSauDataIncomingWAC })(MisTableIncoming);
