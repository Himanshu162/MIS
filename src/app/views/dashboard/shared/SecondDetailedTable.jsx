...
import { getMISDetailTableList, getMISDetailTableListIncomingWAC } from '../../../camunda_redux/redux/action';
...
const DetailedTable = (props) => {
    const { selectionMode, headerText, setLoadData, setLoadingBln } = props;
    ...
    useEffect(() => {
        if (selectionMode === false) {
            ...
            if (headerText.tabIndex === 0) {
                apiFun = props.getMISDetailTableList;
                setDataState = setRowData;
            }
            if (headerText.tabIndex === 1) {
                apiFun = props.getMISDetailTableListIncomingWAC;
...
export default connect(mapStateToProps, { setLoadData, getMISDetailTableList, getMISDetailTableListIncomingWAC })(DetailedTable);
