...
import { getMISTableList, getMISTableListSecret, getMISTableListIncomingSecretWAC } from "../../../camunda_redux/redux/action";
...
const MisTable = (props) => {
    ...
    const loadMisData = () => {
        ...
        if (tabIndex === 0) {
            ...
            apiFun = props.getMISTableListSecret;
            dataState = rowData;
        ...
        if (tabIndex === 1) {
            ...
            apiFun = props.getMISTableListIncomingSecretWAC;
...
export default connect(mapStateToProps, { getMISTableListSecret, getMISTableListIncomingSecretWAC })(MisTable);
