...
import { getMISDetailTableList, getMISDetailTableListSecret, getMISDetailTableListIncomingSecretWAC } from '../../../camunda_redux/redux/action';
    ...
    useEffect(() => {
        if (selectionMode === false) {
            ...
            if (headerText.tabIndex === 0) {
                apiFun = props.getMISDetailTableListSecret;
                setDataState = setRowData;
            }
            if (headerText.tabIndex === 1) {
                apiFun = props.getMISDetailTableListIncomingSecretWAC;
...
export default connect(mapStateToProps, { getMISDetailTableListSecret, getMISDetailTableListIncomingSecretWAC })(DetailedTable);
