...
const API_ROOT = '/misApplication1';
...
export const BACKEND_API_MISS2 = 'BACKEND_API_MISS2';

export default store => next => action => {

    const callAPI = action[BACKEND_API_MISS2]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACKEND_API_MISS2]
        return finalAction
    }
