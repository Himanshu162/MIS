...
const API_ROOT = '/misSecretApplication2';
...
export const BACKEND_API_MISS_SECRET = 'BACKEND_API_MISS_SECRET';

export default store => next => action => {

    const callAPI = action[BACKEND_API_MISS_SECRET]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACKEND_API_MISS_SECRET]
        return finalAction
    }
