...
const API_ROOT = '/MisMicroService';
...
export const MIS_MICRO_SERVICES = 'MIS_MICRO_SERVICES';

export default store => next => action => {

    const callAPI = action[MIS_MICRO_SERVICES]
    ...
    const actionWith = data => {
        ...
        delete finalAction[MIS_MICRO_SERVICES]
        return finalAction
    }
