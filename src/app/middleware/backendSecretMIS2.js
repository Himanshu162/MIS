...
const API_ROOT = '/misSecretApplication1';
...
export const BACKEND_API_MISS_SECRET2 = 'BACKEND_API_MISS_SECRET2';

export default store => next => action => {

    const callAPI = action[BACKEND_API_MISS_SECRET2]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACKEND_API_MISS_SECRET2]
        return finalAction
    }
