    ...
    <MuiThemeProvider theme={settings.themes[settings.activeTheme]}>
      ...
      >
        <Badge color="secondary" badgeContent={5}>
          <Tooltip title="Notification" aria-label="Notification"><Icon style={{fontSize : '30px', marginTop: '-10px', paddingLeft: '5px'}}><img src={process.env.PUBLIC_URL+`/assets/icons/notifications_white_24dp.svg`} alt="Notification" /></Icon></Tooltip>
        </Badge>
      </IconButton>
